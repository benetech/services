...
public class TableResourceClient extends TableEntryClient {
    ...
    public static TableResource transform(TableResourceClient client)
    {
        TableResource resource = new TableResource(new TableEntry(client.getTableId(), client.getDataETag(), client.getSchemaETag()));
        resource.setAclUri(client.getAclUri());
        resource.setDataUri(client.getDataUri());
        resource.setInstanceFilesUri(client.getInstanceFilesUri());
        resource.setDiffUri(client.getDiffUri());
        resource.setSelfUri(client.getSelfUri());
        resource.setDefinitionUri(client.getDefinitionUri());
        return resource;
    }
}
